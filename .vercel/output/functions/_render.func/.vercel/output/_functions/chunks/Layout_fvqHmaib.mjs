import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as renderSlot, e as createAstro, f as addAttribute, s as spreadAttributes, g as createTransitionScope, a as renderComponent, h as renderHead } from './astro/server_DPTWaUMx.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                              */
...
}, "/Users/lanyang/porfolio.dev/src/components/Badge.astro", void 0);
...
}, "/Users/lanyang/porfolio.dev/src/components/SectionContainer.astro", void 0);
...
}, "/Users/lanyang/porfolio.dev/src/components/SocialPill.astro", void 0);
...
}, "/Users/lanyang/porfolio.dev/src/components/icons/LinkedIn.astro", void 0);
...
}, "/Users/lanyang/porfolio.dev/src/components/icons/Sun.astro", void 0);
...
}, "/Users/lanyang/porfolio.dev/src/components/icons/Moon.astro", void 0);
...
}, "/Users/lanyang/porfolio.dev/src/components/icons/System.astro", void 0);
...
}, "/Users/lanyang/porfolio.dev/src/components/ThemeToggle.astro", "self");
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  const navItems = [
    ...
    },
    {
      title: "Contacto",
      label: "contacto",
      url: "mailto:leelanzing@hotmail.com"
    }
  ];
...
}, "/Users/lanyang/porfolio.dev/src/components/Header.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  return renderTemplate`${maybeRenderHead()}<footer class="opacity-80 m-4 min-[375px]:pl-4 md:pl-0 mt-16 w-full mx-auto container lg:max-w-4xl md:max-w-2xl mb-10 flex justify-center"> <div class="rounded-lg w-full max-w-screen-xl mx-auto md:flex md:items-center md:justify-between py-4"> <span class="text-sm sm:text-center text-zinc-800/90 dark:text-zinc-200/90">© ${currentYear} <a href="" class="hover:underline">lanyang</a>. Casi
      todos los derechos reservados
</span> <ul class="flex flex-wrap items-center mt-3 text-sm font-medium dark:text-white/90 sm:mt-0"> <li> <a href="/#sobre-mi" class="hover:underline me-4 md:me-6">Sobre mí</a> </li> <li> <a id="contacto" href="mailto:leelanzing@hotmail.com" class="hover:underline">Contacto</a> </li> </ul> </div> </footer>`;
}, "/Users/lanyang/porfolio.dev/src/components/Footer.astro", void 0);
...
}, "/Users/lanyang/porfolio.dev/node_modules/.pnpm/astro@4.16.4_rollup@4.24.0_typescript@5.3.3/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="description"${addAttribute(description, "content")}><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body class="relative text-black dark:text-white"> <div class="absolute top-0 bottom-0 z-[-2] min-h-screen w-full bg-gray-50 dark:bg-gray-950
      ...
      dark:bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div> ${renderComponent($$result, "Header", $$Header, {})} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})}  ${renderComponent($$result, "Analytics", Analytics, {})} </body></html>`;
}, "/Users/lanyang/porfolio.dev/src/layouts/Layout.astro", void 0);
